...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        RestResponse errorDetails = new RestResponse(errors.toString(), LocalDateTime.now().toString(), HttpStatus.INTERNAL_SERVER_ERROR);
        return new ResponseEntity<>(errorDetails, HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    @ExceptionHandler(NoInvoiceException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<Object> handleNoInvoiceException(NoInvoiceException exception) {
        RestResponse restResponse = new RestResponse(exception.getMessage(), LocalDateTime.now().toString(), HttpStatus.OK);
