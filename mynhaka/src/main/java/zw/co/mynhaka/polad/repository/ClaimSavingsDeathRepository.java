...
@Repository
public interface ClaimSavingsDeathRepository extends JpaRepository<ClaimSavingsDeath, Long> {

    List<ClaimSavingsDeath> findAllByPolicyHolder(PolicyHolder policyHolder);

    List<ClaimSavingsDeath> findByPolicyNumber(String policyNumber);
